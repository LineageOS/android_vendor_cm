...
if not depsonly:
    print("Device %s not found. Attempting to retrieve device repository from Lineage Github (http://github.com/LineageOS)." % device)
...
print("Repository for %s not found in the Lineage Github repository list. If this is in error, you may need to manually add it to your local_manifests/roomservice.xml." % device)
